...
<Steps>
  ...
  <Step title="Select Close Call">
    ...
    If no units from the primary agency are assigned (desk / paper call), the dialog offers **Close as Desk Call**. Cadmus assigns an organization **Dispatch Desk** unit and completes the normal close workflow (narratives, timestamps, and close side effects).
  </Step>
