...
When **Incident Details** has text, an optional **Share description with units via link** checkbox appears under the field. It is off by default; leave it unchecked unless units should see the description on the SMS call link immediately after create.
