...
| `EMAIL user@example.com` | Generate the **CFS PDF** and email it to the address(es) listed. Multiple addresses: separate with spaces. On **Call Detail**, you can also use **Copy summary**, **PDF / Print**, and **Email PDF** in the call summary block. |
