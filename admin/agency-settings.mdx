---
title: "Agency Settings: NCIC, Traffic Stops, Unit Login, and Report Numbers"
sidebarTitle: "Agency Settings"
description: "Configure agency-level toggles in Cadmus Web Admin — enable NCIC access, require dispatch unit login for MDT users, allow traffic stops, and set up RMS report number formats."
---
